        ...
        {detailLoading ? (
          ...
          <>
            <div className="bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-xl p-4 md:p-6 space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    <h2 className="text-lg font-bold text-[color:var(--text-primary)]">{s.title}</h2>
              ...
              {s.description && <p className="text-sm text-[color:var(--text-secondary)]">{s.description}</p>}
              ...
              {s.file_url && (
                <a
                  ...
                  className="flex items-center gap-2 px-3 py-2.5 bg-[var(--bg-tertiary)] hover:bg-[var(--bg-hover)] rounded-lg text-sm text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] transition-colors min-h-[44px] inline-flex"
                >
                ...
                <div className="space-y-1">
                  {s.acknowledgments.map((a) => (
                    <div key={a.foreman_id} className="flex items-center justify-between py-1.5 text-xs">
                      <span className="text-[color:var(--text-secondary)]">{a.foreman_name}</span>
                      {a.acknowledged_at ? (
