...
export default function FieldReportDetail({ projectId, report: initialReport, onBack, getPhotoUrl }: Props) {
  ...
  const handleMarkup = () => {
    ...
    if (typeof window !== "undefined") {
      ...
      el.className =
        "fixed bottom-20 left-1/2 -translate-x-1/2 bg-[#1F1F25] text-[color:var(--text-primary)] px-4 py-2 rounded-lg text-sm font-medium z-50 shadow-lg";
    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="mb-4">
        ...
        <input
          ...
          className="w-full bg-[#121217] border border-[#1F1F25] rounded-lg px-3 py-2.5 text-[color:var(--text-primary)] text-sm focus:outline-none focus:border-[#F97316] transition-colors min-h-[44px]"
        />
      </div>
      ...
      <div className="mb-4">
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-[#121217] border border-[#1F1F25] rounded-lg px-3 py-2.5 text-[color:var(--text-primary)] text-sm focus:outline-none focus:border-[#F97316] transition-colors placeholder:text-gray-600 resize-none"
        />
      </div>
