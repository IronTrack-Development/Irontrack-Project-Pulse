    ...
    <div className="md:hidden">
      ...
      {open && (
        <div className="fixed left-0 right-0 top-[64px] z-50 flex flex-col gap-3 border-b border-[rgba(13,13,13,0.08)] bg-[#F5F3EE] px-5 py-5 shadow-xl">
          ...
          <a href="#features" onClick={() => setOpen(false)} className="text-sm font-semibold text-[#0D0D0D]/70 hover:text-[#0D0D0D]">Features</a>
          <a href="#who-we-serve" onClick={() => setOpen(false)} className="text-sm font-semibold text-[#0D0D0D]/70 hover:text-[#0D0D0D]">Who We Serve</a>
