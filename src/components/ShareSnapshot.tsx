          ...
          <div className="w-full max-w-lg bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-2xl shadow-2xl flex flex-col">
            ...
            <div className="px-5 py-4 flex-1">
              ...
              {snapshotText && !loading && (
                <pre className="whitespace-pre-wrap text-xs text-[color:var(--text-secondary)] font-mono leading-relaxed bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-xl px-4 py-3 max-h-72 overflow-y-auto">
                  {snapshotText}
                </pre>
              )}
            </div>
