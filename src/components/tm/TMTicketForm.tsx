...
export default function TMTicketForm({ projectId, contacts, onCreated, onCancel }: Props) {
  ...
  const inputClass =
    "w-full px-3 py-2.5 bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-xl text-white text-sm placeholder-gray-600 focus:outline-none focus:border-[#F97316] transition-colors min-h-[44px]";
  const labelClass = "block text-xs font-medium text-gray-400 mb-1.5";
  const numInputClass =
    "w-full px-2.5 py-2 bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-lg text-white text-sm text-right focus:outline-none focus:border-[#F97316] transition-colors min-h-[44px]";
          ...
          <div className="p-4 space-y-5">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full px-3 py-2.5 bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-xl text-white text-sm placeholder-gray-600 focus:outline-none focus:border-[#F97316] transition-colors resize-none"
              />
            </div>
            ...
            <div>
              ...
              {laborRows.map((row, i) => (
                <div key={i} className="mb-2 p-3 bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-xl">
              ...
              <button
                onClick={addLabor}
                className="flex items-center gap-1.5 px-3 py-2 text-xs text-gray-400 hover:text-[#F97316] border border-dashed border-[var(--border-primary)] hover:border-[#F97316]/50 rounded-xl transition-colors w-full justify-center min-h-[44px]"
              >
                <Plus size={13} />
                Add Labor
              </button>
            ...
            <div className="flex gap-2 pb-2">
              <button
                onClick={onCancel}
                className="flex-1 py-3 px-4 bg-[var(--bg-tertiary)] hover:bg-[var(--bg-hover)] text-gray-300 rounded-xl text-sm font-medium transition-colors min-h-[44px]"
              >
                Cancel
              </button>
              <button
