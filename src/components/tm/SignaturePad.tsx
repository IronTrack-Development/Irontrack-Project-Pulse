    ...
    <div className="fixed inset-0 z-50 bg-black/80 flex items-end sm:items-center justify-center p-0 sm:p-4">
      <div className="w-full sm:max-w-md bg-[var(--bg-secondary)] rounded-t-2xl sm:rounded-2xl border border-[var(--border-primary)] overflow-hidden">
        ...
        <div className="flex gap-2 px-4 pb-4 pt-2">
          <button
            onClick={clear}
            className="flex items-center gap-1.5 px-4 py-3 bg-[var(--bg-tertiary)] hover:bg-[var(--bg-hover)] text-gray-300 rounded-xl text-sm font-medium transition-colors min-h-[44px] flex-1 justify-center"
          >
            <RotateCcw size={15} />
            Clear
          </button>
