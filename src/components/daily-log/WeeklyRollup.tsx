    ...
    <div>
      ...
      <div className="flex items-center gap-3 mb-4">
        ...
        <a
          ...
          className="ml-auto flex items-center gap-1.5 px-3 py-2 bg-[var(--bg-tertiary)] hover:bg-[var(--bg-hover)] text-[color:var(--text-secondary)] rounded-xl text-xs font-medium transition-colors min-h-[40px]"
        >
