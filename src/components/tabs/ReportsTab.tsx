            ...
            >
                    ...
                    <div className="flex items-center gap-1 shrink-0">
                      {(report.status === "generated" || report.status === "shared") && (
                        <a
                          ...
                          className="p-1.5 rounded-lg bg-[var(--bg-tertiary)] text-gray-400 hover:text-[#F97316] transition-colors"
                          title="View PDF"
                        >
                      ...
                      <button
                        ...
                        className="p-1.5 rounded-lg bg-[var(--bg-tertiary)] text-gray-400 hover:text-[#EF4444] transition-colors disabled:opacity-40"
              ...
              {(report.status === "generated" || report.status === "shared") && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 py-2.5 border-t border-[var(--border-primary)] text-xs text-gray-500 hover:text-[#F97316] hover:bg-[#F97316]/5 transition-all"
                >
                  View Observation
