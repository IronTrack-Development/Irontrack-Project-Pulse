        ...
        <div className="flex gap-2 shrink-0">
          {jurisdiction.portal_url && (
            <a
              ...
              className="inline-flex items-center gap-1.5 px-3 py-2 bg-[var(--bg-tertiary)] text-gray-300 rounded-lg text-xs font-medium hover:bg-[var(--bg-hover)] transition-colors min-h-[36px]"
            >
