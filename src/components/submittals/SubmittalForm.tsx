    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm p-0 sm:p-4">
      <div className="bg-[#121217] border border-[#1F1F25] rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[92dvh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-[#121217] border-b border-[#1F1F25] px-5 py-4 flex items-center justify-between z-10">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg text-gray-400 hover:text-white hover:bg-[#1F1F25] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center"
          >
            <X size={18} />
          </button>
        </div>
        ...
        <form onSubmit={handleSubmit} className="p-5 space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                placeholder="S-001"
                required
                className="w-full bg-[#0B0B0D] border border-[#1F1F25] rounded-xl px-3 py-2.5 text-white text-sm focus:outline-none focus:border-[#F97316]/50 placeholder-gray-600"
              />
            </div>
            <div>
          ...
          <div>
            ...
            <textarea
              ...
              rows={2}
              className="w-full bg-[#0B0B0D] border border-[#1F1F25] rounded-xl px-3 py-2.5 text-white text-sm focus:outline-none focus:border-[#F97316]/50 placeholder-gray-600 resize-none"
            />
          </div>
                ...
                <button
                  ...
                  className={`px-3 py-2 rounded-lg text-xs font-medium transition-colors min-h-[36px] ${
                    form.priority === p.value
                      ...
                      : "bg-[#0B0B0D] border border-[#1F1F25] text-gray-400 hover:text-white"
                  }`}
                >
                  {p.label}
                </button>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div>
              ...
              <input
                ...
                className="w-full bg-[#0B0B0D] border border-[#1F1F25] rounded-xl px-3 py-2.5 text-white text-sm focus:outline-none focus:border-[#F97316]/50"
              />
            </div>
            <div>
