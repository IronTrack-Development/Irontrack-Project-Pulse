    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center bg-black/60 backdrop-blur-sm p-0 sm:p-4">
      <div className="bg-[var(--bg-secondary)] border border-[var(--border-primary)] rounded-t-2xl sm:rounded-2xl w-full sm:max-w-lg max-h-[92dvh] overflow-y-auto">
        ...
        <div className="sticky top-0 bg-[var(--bg-secondary)] border-b border-[var(--border-primary)] px-5 py-4 flex items-start justify-between z-10">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-lg text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] hover:bg-[var(--bg-tertiary)] transition-colors min-w-[44px] min-h-[44px] flex items-center justify-center shrink-0"
          >
            ✕
          </button>
        </div>
        ...
        {loading || !submittal ? (
          ...
          <div className="p-5 space-y-5">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <span className="px-2.5 py-1 rounded-full text-xs font-semibold bg-[var(--bg-tertiary)] text-[color:var(--text-secondary)]">
