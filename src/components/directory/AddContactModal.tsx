            ...
            <div className="space-y-3">
              <div className="relative">
                ...
                <input
                  ...
                  autoFocus
                  className="w-full bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-xl pl-9 pr-3 py-3 text-white text-sm focus:outline-none focus:border-[#F97316]/50 placeholder-gray-600"
                />
              </div>
              ...
              <div className="grid grid-cols-1 gap-3">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-xl px-3 py-3 text-white text-sm focus:outline-none focus:border-[#F97316]/50 placeholder-gray-600"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-xl px-3 py-3 text-white text-sm focus:outline-none focus:border-[#F97316]/50"
                  >
        ...
        {(mode === "new" || isEdit) && (
          <div className="flex-none px-5 py-4 pb-8 sm:pb-4 border-t border-[var(--border-primary)] bg-[var(--bg-secondary)]">
            <div className="flex gap-3">
              <button
                onClick={onClose}
                className="flex-1 py-3 bg-[var(--bg-tertiary)] text-gray-300 hover:text-white rounded-xl text-sm font-medium transition-colors"
              >
                Cancel
              </button>
              <button
