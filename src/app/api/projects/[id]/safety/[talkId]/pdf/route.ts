...
<body>
  <div class="header">
    <h1>TOOLBOX TALK</h1>
    <div class="subtitle">${project?.name || "Project"} ${project?.project_number ? `— #${project.project_number}` : ""}</div>
  </div>
  <div class="content">
    <div class="meta-grid">
      <div class="meta-item">
  ...
  <div class="footer">
    Generated by IronTrack Pulse — ${new Date().toLocaleDateString("en-US", { year: "numeric", month: "long", day: "numeric" })} at ${new Date().toLocaleTimeString("en-US", { hour: "2-digit", minute: "2-digit" })}
  </div>
</body>
</html>`;
