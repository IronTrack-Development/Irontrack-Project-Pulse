...
export async function GET(
  ...
  const statusBadge = (status: string) => {
    const colors: Record<string, string> = {
      pending: "#3B82F6", discussed: "#F37021", deferred: "#EAB308", resolved: "#22C55E",
      open: "#3B82F6", in_progress: "#EA580C", cancelled: "#6B7280",
    };
...
<head>
  ...
  <style>
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header { border-bottom: 3px solid #F37021; padding-bottom: 16px; margin-bottom: 24px; }
    .header h1 { font-size: 24px; color: #0B0B0D; }
    .header .meta { color: #666; font-size: 13px; margin-top: 8px; }
    .section { margin-bottom: 24px; }
    .section h2 { font-size: 16px; color: #F37021; border-bottom: 1px solid #ddd; padding-bottom: 4px; margin-bottom: 12px; }
