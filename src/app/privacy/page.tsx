    ...
    <div className="min-h-screen bg-[var(--bg-primary)]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-sm text-gray-500">IronTrack Project Pulse</span>
        </div>

        <h1 className="text-4xl font-bold text-white mb-4">Privacy Policy</h1>
        <p className="text-gray-400 mb-8">Last updated: April 10, 2026</p>
        ...
        <div className="space-y-8 text-gray-400 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-4 space-y-2 ml-4">
              <li><strong className="text-white">Email address</strong> — for your account and login</li>
              <li><strong className="text-white">Password (hashed)</strong> — we never store your actual password, only a secure hash</li>
              <li><strong className="text-white">Uploaded schedule files</strong> — .mpp, .xlsx, .csv, .xml, .xer files you upload</li>
              <li><strong className="text-white">Usage data</strong> — when you log in, which features you use, error logs</li>
              <li><strong className="text-white">Payment information</strong> — handled entirely by Stripe; we never see your credit card number</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-4 space-y-2 ml-4">
              <li><strong className="text-white">Provide the Service</strong> — parse your schedules, display lookaheads, track milestones</li>
              <li><strong className="text-white">Manage your account</strong> — authentication, subscription, session management</li>
              <li><strong className="text-white">Process billing</strong> — charge your subscription via Stripe</li>
              <li><strong className="text-white">Improve the platform</strong> — analyze anonymized, aggregate data (see below)</li>
              <li><strong className="text-white">Communicate with you</strong> — respond to support requests, send important updates</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-4 space-y-2 ml-4">
              <li><strong className="text-white">Supabase (PostgreSQL)</strong> — cloud database for user accounts and project data</li>
              <li><strong className="text-white">Vercel</strong> — serverless hosting for the application</li>
              <li><strong className="text-white">Stripe</strong> — payment processing (PCI-compliant)</li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-4 space-y-2 ml-4">
              ...
              <li><strong className="text-white">Anthropic (Claude AI)</strong> — schedule file parsing</li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              <strong className="text-white">Active accounts:</strong> We keep your data as long as your account is active.
            </p>
            <p className="mt-4">
              <strong className="text-white">Deleted accounts:</strong> When you delete your account, we remove your personal data and uploaded files within <strong className="text-white">30 days</strong>.
            </p>
            <p className="mt-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-4 space-y-2 ml-4">
              <li><strong className="text-white">Access your data</strong> — request a copy of what we have</li>
              <li><strong className="text-white">Export your data</strong> — download your uploaded schedules</li>
              <li><strong className="text-white">Delete your data</strong> — close your account and have data removed</li>
              <li><strong className="text-white">Correct your data</strong> — update inaccurate information</li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <ul className="list-disc list-inside mt-4 space-y-2 ml-4">
              <li><strong className="text-white">Encryption in transit</strong> — all data sent over HTTPS</li>
              <li><strong className="text-white">Encryption at rest</strong> — database and file storage encrypted</li>
              <li><strong className="text-white">Row-Level Security (RLS)</strong> — database policies ensure users only access their own data</li>
              <li><strong className="text-white">Single session enforcement</strong> — prevents account sharing and unauthorized access</li>
              <li><strong className="text-white">Password hashing</strong> — we never store plain-text passwords</li>
            </ul>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              We use cookies only for <strong className="text-white">authentication</strong> (Supabase session cookies). We do not use tracking cookies, advertising cookies, or third-party analytics.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-4">
              <strong className="text-white">IronTrack Development LLC</strong><br />
              <a href="mailto:irontrackdevelopment@outlook.com" className="text-[#F97316] hover:text-[#EA580C]">
                irontrackdevelopment@outlook.com
              </a>
            </p>
