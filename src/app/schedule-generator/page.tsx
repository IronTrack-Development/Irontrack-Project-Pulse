          ...
          {schedule && (
            <div className="ml-auto flex items-center gap-2">
              <button
                ...
                className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-[var(--bg-tertiary)] border border-[var(--border-secondary)] hover:border-[#F97316]/40 text-sm text-gray-300 hover:text-white transition-colors"
              >
                <Download size={14} />
                XLSX
              </button>
                  ...
                  <button
                    ...
                    className={`flex-1 py-2 text-sm font-medium transition-colors ${
                      !isGroundUp
                        ...
                        : 'bg-[var(--bg-primary)] text-gray-400 hover:text-gray-300'
                    }`}
                  >
                    Tenant Improvement
                  </button>
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="text-xs text-gray-500 hover:text-gray-300 transition-colors px-2 py-1 rounded hover:bg-[var(--bg-tertiary)]"
                  >
                    All
                  </button>
                  <button
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-3 py-2 rounded-lg border text-sm text-left transition-colors ${
                        checked
                          ...
                          : 'border-[var(--border-primary)] bg-[var(--bg-primary)] text-gray-500 hover:text-gray-400 hover:border-[var(--border-secondary)]'
                      }`}
                    >
                      {checked ? (
        ...
        {schedule && (
          <div className="space-y-6">
            ...
            <div className="bg-[#111115] border border-[var(--border-primary)] rounded-xl overflow-hidden">
                  ...
                  <button
                    ...
                    className={`flex items-center gap-1.5 text-xs px-2.5 py-1.5 rounded-lg border transition-colors ${
                      showCriticalOnly
                        ...
                        : 'border-[var(--border-primary)] text-gray-500 hover:text-gray-400'
                    }`}
                  >
                    <Flag size={11} />
                    Critical Only
              ...
              <div className="overflow-x-auto">
                <table className="w-full text-xs">
                  <thead>
                    <tr className="border-b border-[var(--border-primary)] text-gray-500">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <button
                onClick={handleExportXLSX}
                className="flex-1 flex items-center justify-center gap-2 py-3 rounded-xl bg-[#111115] border border-[var(--border-primary)] hover:border-[#F97316]/40 text-gray-300 hover:text-white font-medium text-sm transition-colors"
              >
                <Download size={16} />
