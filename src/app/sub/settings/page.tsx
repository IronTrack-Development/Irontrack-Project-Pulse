  ...
  return (
    <div className="mx-auto max-w-4xl space-y-5 px-4 py-5 md:px-6 md:py-7">
      <div className="rounded-xl border border-white/10 bg-[linear-gradient(135deg,rgba(59,130,246,0.16),rgba(15,23,42,0.72)_50%,rgba(249,115,22,0.1))] p-5 shadow-[0_24px_70px_rgba(0,0,0,0.2)]">
        <p className="text-[10px] font-bold uppercase tracking-[0.22em] text-[#93C5FD]">Portal Settings</p>
        <h1 className="mt-2 text-2xl font-black text-white md:text-3xl">Make IronTrack Feel Right</h1>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-slate-300">
          Tune appearance for the way your crew works, then get back to field updates without hunting through menus.
        </p>
      </div>
      ...
      <div className="rounded-lg border border-[var(--border-primary)] bg-[var(--bg-secondary)] p-5 shadow-[0_18px_55px_rgba(0,0,0,0.16)] md:p-6">
        <div className="mb-4 flex items-center gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-[color:var(--text-primary)]">Appearance</h2>
            <p className="text-sm text-[color:var(--text-muted)]">Theme controls apply across the GC app and Sub Portal.</p>
          </div>
        </div>
        <AppearanceSettings />
      </div>
      ...
      <div className="rounded-lg border border-[var(--border-primary)] bg-[var(--bg-secondary)] p-5 shadow-[0_18px_55px_rgba(0,0,0,0.16)] md:p-6">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-lg font-bold text-[color:var(--text-primary)]">About</h2>
            <p className="mt-1 text-sm text-[color:var(--text-secondary)]">IronTrack Pulse v2.0 - Sub Portal</p>
          </div>
        </div>
        <a
