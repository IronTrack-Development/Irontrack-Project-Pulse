      ...
      <div className="max-w-4xl mx-auto px-4 py-8 space-y-8">
        ...
        <section className="space-y-4">
          <div className="flex items-center gap-2">
            ...
            {projects.length > 0 && (
              <span className="text-xs px-2 py-0.5 rounded-full bg-[var(--bg-tertiary)] text-gray-400">
                {projects.length}
              </span>
            )}
          </div>
            ...
            {canLoadMore && (
              <div className="flex justify-center pt-2">
                <button
                  ...
                  className="px-5 py-2.5 bg-[var(--bg-tertiary)] hover:bg-[#2A2A33] border border-[#2A2A33] text-sm text-gray-300 rounded-xl transition-colors"
                >
                  Load More
                </button>
              </div>
