              ...
              {showNewProject ? (
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-lg px-3 py-2 text-white text-sm focus:outline-none focus:border-[#F97316]/50"
                    onKeyDown={(e) => e.key === "Enter" && createProject()}
                  />
                  <button onClick={createProject} className="px-4 py-2 bg-[#F97316] text-white rounded-lg text-sm font-semibold">
                    Create
                  </button>
                  <button onClick={() => setShowNewProject(false)} className="px-3 py-2 bg-[var(--bg-tertiary)] text-gray-400 rounded-lg">
                    <X size={16} />
                  </button>
                </div>
              ) : (
                <div className="flex gap-3">
                  <select
                    ...
                    className="flex-1 bg-[var(--bg-primary)] border border-[var(--border-primary)] rounded-lg px-3 py-2.5 text-white text-sm focus:outline-none focus:border-[#F97316]/50"
                  >
                  ...
                  <button
                    ...
                    className="flex items-center gap-1.5 px-4 py-2 bg-[var(--bg-tertiary)] text-gray-300 hover:text-white rounded-lg text-sm transition-colors"
                  >
                    <Plus size={14} />
                    New
                  </button>
                ...
                <>
                  ...
                  <div className="flex items-center justify-center gap-1.5 md:gap-2 flex-wrap">
                    {[".xlsx", ".csv", ".mpp", ".xml", ".xer"].map((ext) => (
                      <span key={ext} className="text-xs bg-[var(--bg-tertiary)] text-gray-500 px-2 py-1 rounded font-mono">
                        {ext}
                      </span>
                    ))}
                  </div>
