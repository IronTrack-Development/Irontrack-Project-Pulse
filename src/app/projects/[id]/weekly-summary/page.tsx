    ...
    <div className="min-h-screen bg-white text-gray-900 print:bg-white">
      ...
      <div className="max-w-4xl mx-auto px-8 py-10 print:px-6 print:py-6">
        ...
        <section className="mb-8">
          <h2 className="text-base font-bold text-gray-700 uppercase tracking-wider mb-2 border-b border-gray-200 pb-1">
            Executive Summary
          </h2>
        ...
        {/* ── Schedule Status ─────────────────────────────────────────────── */}
        <section className="mb-8">
          <h2 className="text-base font-bold text-gray-700 uppercase tracking-wider mb-3 border-b border-gray-200 pb-1">
            Schedule Status
          </h2>
          <div className="grid grid-cols-5 gap-3 mb-3">
            {[
              { label: "Total", value: schedule.totalActivities, color: "text-gray-700" },
              { label: "Complete", value: schedule.completeActivities, color: "text-green-600" },
              { label: "In Progress", value: schedule.inProgressActivities, color: "text-orange-500" },
              { label: "Late", value: schedule.lateActivities, color: "text-red-600" },
              { label: "% Complete", value: `${schedule.overallPercent}%`, color: "text-blue-600" },
