    ...
    <div className="min-h-screen bg-[#0B0B0D]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="space-y-8 text-gray-400 leading-relaxed">
          ...
          {/* Account Terms */}
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">3. Account Terms</h2>
            <p>
              Your account is for <strong className="text-white">one person only</strong>. You may not share your login credentials with anyone. The Service enforces single-session authentication — if you log in from a new location, previous sessions are automatically ended.
            </p>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              IronTrack Project Pulse is a subscription service. The current price is <strong className="text-white">$19.99 per month</strong>, billed automatically via Stripe.
            </p>
            <p className="mt-4">
              <strong className="text-white">Cancellation:</strong> You may cancel at any time. Your access will continue until the end of your current billing period. We do not offer refunds for partial months.
            </p>
            <p className="mt-4">
              <strong className="text-white">Price changes:</strong> We may change the subscription price with 30 days&apos; notice. Continued use after the notice period means you accept the new price.
            </p>
            <p className="mt-4">
              <strong className="text-white">Payment failures:</strong> If your payment method fails, we may suspend your account until payment is resolved.
            </p>
          </section>
          ...
          {/* Uploaded Content */}
          <section>
            <h2 className="text-2xl font-bold text-white mb-4">6. Uploaded Content and Ownership</h2>
            <p>
              <strong className="text-white">You own your data.</strong> All schedule files and project information you upload remain your property.
            </p>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              You agree <strong className="text-white">not to</strong>:
            </p>
            <ul className="list-disc list-inside mt-4 space-y-2 ml-4">
          ...
          <section>
            ...
            <p>
              We work hard to keep the Service running, but we <strong className="text-white">do not guarantee 100% uptime</strong>. The Service is provided "as is" and may be temporarily unavailable for maintenance, updates, or unforeseen issues.
            </p>
            <p className="mt-4">
          ...
          <section>
            ...
            <p>
              IronTrack Project Pulse is a tool to help you track schedules. It is <strong className="text-white">not a substitute for professional judgment</strong>. You are responsible for verifying all schedule data and making project decisions.
            </p>
            <p className="mt-4">
