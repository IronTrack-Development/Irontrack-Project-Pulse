      ...
      <div className="max-w-2xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="bg-[#121217] border border-[#1F1F25] rounded-2xl p-6">
          <div className="flex items-center justify-between mb-4">
            ...
            <button onClick={checkSetup} className="p-2 rounded-lg bg-[#1F1F25] text-[color:var(--text-secondary)] hover:text-[color:var(--text-primary)] transition-colors">
          ...
          <div className="bg-[#121217] border border-[#1F1F25] rounded-2xl p-6">
            ...
            <ol className="space-y-3 text-sm text-[color:var(--text-secondary)] mb-5">
              ...
              <li className="flex gap-2">
                ...
                Open the file at: <code className="text-[color:var(--text-secondary)] font-mono bg-[#0B0B0D] px-1 rounded">src/migrations/001_irontrack_daily.sql</code>
              </li>
              <li className="flex gap-2">
              ...
              <li className="flex gap-2">
                ...
                Run the seed: <code className="text-[color:var(--text-secondary)] font-mono bg-[#0B0B0D] px-1 rounded">npx tsx src/seed/seed-demo.ts</code>
              </li>
            </ol>

            <button
              onClick={copySQL}
              className="flex items-center gap-2 px-4 py-2 bg-[#1F1F25] hover:bg-[#2a2a35] text-[color:var(--text-secondary)] rounded-lg text-sm transition-colors"
            >
              <Copy size={14} />
